<script>
    ...
    const handleKeydown = (/** @type {{ key: any; keyCode: any; }} */ event) => {
        const key = event.key;
...
<div class="w-screen h-screen fixed inset-0 flex justify-center items-center bg-gray-200 opacity-90 z-10" on:click={() => isOverlayOpen.set(false)}>
    <div 
